...
func (p Profile) Evaluate(sourceVideoStats convertor.VideoStats) (convertor.VideoStats, error) {
	if err := p.Rules.ShouldConvert(p, sourceVideoStats); err != nil {
		return convertor.VideoStats{}, err
	}
	var stats convertor.VideoStats
...
func (p Profile) getTargetBitRate(videoStats convertor.VideoStats) (int, error) {
	return getTargetBitRate(videoStats, p.Codec, p.Quality)
}

////////////////////////////////////////////////////////////////////////////////////////////////////////

type Rule func(profile Profile, stats convertor.VideoStats) error

type Rules []Rule

func (r Rules) ShouldConvert(profile Profile, stats convertor.VideoStats) error {
	for _, rule := range r {
...
func SkipTargetCodec() Rule {
	return func(profile Profile, stats convertor.VideoStats) error {
...
func SkipCodec(codec string) Rule {
	return func(_ Profile, stats convertor.VideoStats) error {
