...
func TestProgress(t *testing.T) {
	tests := []struct {
		...
		},
		{
			name:          "half done",
			duration:      time.Hour,
			progress:      converter.Progress{Speed: 1, Converted: 30 * time.Minute},
			wantCompleted: .5,
		...
		},
		{
			name:          "speed matters",
			duration:      time.Hour,
			progress:      converter.Progress{Speed: 2, Converted: 30 * time.Minute},
			wantCompleted: .5,
		...
		},
		{
			name:          "completed",
			duration:      time.Hour,
			progress:      converter.Progress{Speed: 2, Converted: time.Hour},
			wantCompleted: 1,
			wantRemaining: 0,
		},
		{
			name:          "zero speed",
			duration:      time.Hour,
			progress:      converter.Progress{Converted: 30 * time.Minute},
			prevSpeed:     2,
			wantCompleted: .5,
			wantRemaining: 15 * time.Minute,
		},
